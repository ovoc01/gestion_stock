...
export const getAllUnite = async ({
  ...
  const response = await axios.get(
    `${BASE_URL}unites?page=${page}&size=${size}&fetch=${fetch}`,
    {
...
export const getAllFamilles = async ({ page, size }: PaginationProps) => {
  const response = await axios.get(
    BASE_URL + "familles?page=" + page + "&size=" + size,
    {
      headers: requestHeaders,
    },
  );
...
export const updateFamille = async (
  familleId: number,
  label: string,
  dateCreation: Date,
) => {
  const response = await axios.put(
    BASE_URL + `familles/${familleId}`,
    {
      familleId: familleId,
      familleLi: label,
      familleDtCr: dateCreation,
...
export const getAllSousFamilles = async ({ page, size }: PaginationProps) => {
  const response = await axios.get(
    BASE_URL + "sous-familles?page=" + page + "&size=" + size,
    {
      headers: requestHeaders,
    },
  );
...
export const createSousFamille = async (
  familleId: number,
  label: string,
  dateCreation: Date,
) => {
  const response = await axios.post(
    BASE_URL + "sous-familles",
    {
      familleId: familleId,
      sousFamLi: label,
...
export const deleteSousFamille = async (sousFamilleId: number) => {
  const response = await axios.delete(
    BASE_URL + `sous-familles/${sousFamilleId}`,
    {
      headers: requestHeaders,
    },
  );
...
export const updateSousFamille = async (
...
export const getAllArticles = async ({
  ...
  const response = await axios.get(
    `${BASE_URL}articles?page=${page}&size=${size}&fetch=${fetch}`,
    {
      headers: requestHeaders,
