import { buildUserClaims, checkUserSessionValidity } from "@/services/api/auth.service";
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
   ...
   return (
      <AuthContext.Provider value={{ isAuthenticated, setIsAuthenticated, userClaims }}>
         {children}
